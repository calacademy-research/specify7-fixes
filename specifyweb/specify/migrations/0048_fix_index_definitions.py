"""
Fix index definitions created in 0047:
...
For databases that ran the original 0047, this drops the old indexes.
For fresh databases (running revised 0047 directly), the drops are no-ops.
"""
...
def drop_old_indexes(apps, schema_editor):
    """Drop indexes from the original 0047 if they exist."""
